...
#INSERINDO DADOS NA TABELA BUYER
...
#INSERINDO DADOS NA TABELA BankCard
...
#INSERINDO DADOS NA TABELA creditCard
...
#INSERINDO DADOS NA TABELA debitCard
...
#excluindo a coluna organization
ALTER TABLE debitCard DROP COLUMN organization;

#INSERINDO DADOS NA TABELA store

#botando as colunas na ordem em que os dados estão sendo inseridos
...
#INSERINDO DADOS NA TABELA servicepoint
...
#mudando a coluna starTime para um dado VARCHAR para poder inserir a hora em que o serviço começou
ALTER TABLE servicepoint MODIFY COLUMN startTime VARCHAR(8);

#mudando a coluna starTime para um dado VARCHAR para poder inserir a hora em que o serviço começou
ALTER TABLE servicepoint MODIFY COLUMN endTime VARCHAR(8);
...
#alterando a coluna creationTime para o dado ser DATE e mostrar quando foi comentado
ALTER TABLE comments MODIFY COLUMN creationTime DATE NOT NULL;

#alterando a coluna content para aumentar a quantidade de caracteres em um comentário
ALTER TABLE comments MODIFY COLUMN content VARCHAR(500);


#INSERINDO DADOS NA TABELA save_to_shopping_cart
...
#INSERINDO DADOS NA TABELA manage
...
#INSERINDO DADOS NA TABELA after_sales_services_at
...
SHOW COLUMNS from after_sales_service_at;
...
#INSERINDO DADOS NA TABELA contain
